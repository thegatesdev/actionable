...
public class ReactorBuilder<E> implements DataBuilder<ClassListener<E>>, Keyed {
    ...
    private final Options.Builder options;
    private Options builtOptions;
    ...
    public ReactorBuilder(String key, Class<E> eventClass) {
        this(key, eventClass, new Options.Builder());
    }

    public ReactorBuilder(String key, Class<E> eventClass, Options.Builder builder) {
        this.key = key;
        this.eventClass = eventClass;
        this.options = builder;
        builder.add("cancel", Readable.bool(), false);
    }
    ...
    public Options options() {
        if (builtOptions == null) builtOptions = options.build();
        return builtOptions;
    }
